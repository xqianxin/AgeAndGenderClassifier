...
if __name__ == "__main__":
    #imagePath = "/Users/anton/OpenCV/gender_classification/male/Arnold.jpg"
    image = Image.open("/Users/anton/Desktop/selfie/8.jpg")
    eye_left = (61, 122)
    eye_right = (130, 123)

    CropFace(image, eye_left, eye_right, offset_pct=(0.3, 0.3), dest_sz=(200, 200)).save(
        "1.jpg")
